defmodule SecretHub.WebWeb.UserSocket do
  @moduledoc """
  ...
  # Channel routes
  channel "agent:*", SecretHub.WebWeb.AgentChannel
  ...
  #
  #     Elixir.SecretHub.WebWeb.Endpoint.broadcast("user_socket:#{user.id}", "disconnect", %{})
  #
