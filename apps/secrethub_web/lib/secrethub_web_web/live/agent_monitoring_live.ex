defmodule SecretHub.WebWeb.AgentMonitoringLive do
  @moduledoc """
  ...
  defp fetch_agents do
    ...
    [
      %{
        ...
        connection_time: DateTime.utc_now() |> DateTime.add(-48, :hour),
        last_policy_check: DateTime.utc_now() |> DateTime.add(-600, :second)
      },
      %{
        id: "agent-prod-02",
        name: "Backend Worker",
        ...
        connection_time: nil,
        last_policy_check: DateTime.utc_now() |> DateTime.add(-2400, :second)
      },
      %{
        id: "agent-dev-01",
        name: "Development Environment",
        status: :error,
        last_seen: DateTime.utc_now() |> DateTime.add(-7200, :second),
        secrets_accessed: 8,
        uptime_hours: 2.1,
        os: "macos",
        ...
        connection_time: DateTime.utc_now() |> DateTime.add(-2, :hour),
        last_policy_check: DateTime.utc_now() |> DateTime.add(-7200, :second)
      }
    ]
  end
