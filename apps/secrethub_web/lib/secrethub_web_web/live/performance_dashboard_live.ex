defmodule SecretHub.WebWeb.PerformanceDashboardLive do
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div class="bg-white rounded-lg shadow p-6">
          ...
          <div class="space-y-4">
            ...
            <div class="w-full bg-gray-200 rounded-full h-2">
              <div class={"h-2 rounded-full #{pool_color(@metrics.db_pool_utilization)}"} style={"width: #{@metrics.db_pool_utilization}%"}></div>
            </div>
        ...
        <div class="bg-white rounded-lg shadow p-6">
          ...
          <div class="space-y-4">
            ...
            <div class="w-full bg-gray-200 rounded-full h-2">
              <div class="bg-green-500 h-2 rounded-full" style={"width: #{@metrics.cache_hit_rate}%"}></div>
            </div>

            <div class="grid grid-cols-2 gap-4 pt-2">
              <div>
                <span class="text-sm text-gray-600">Policy Cache</span>
                <p class="text-lg font-medium text-gray-900">{@metrics.cache_sizes.policy_cache} KB</p>
              </div>
              <div>
                <span class="text-sm text-gray-600">Secret Cache</span>
                <p class="text-lg font-medium text-gray-900">{@metrics.cache_sizes.secret_cache} KB</p>
              </div>
            </div>

            <div class="flex justify-between items-center pt-2">
              <span class="text-sm text-gray-600">Total Cache Hits</span>
              <span class="text-sm font-medium text-gray-900">{format_number(@metrics.cache_hits)}</span>
            </div>

            <div class="flex justify-between items-center">
              <span class="text-sm text-gray-600">Total Cache Misses</span>
              <span class="text-sm font-medium text-gray-900">{format_number(@metrics.cache_misses)}</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="bg-white rounded-lg shadow p-6">
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-6">
          ...
          <div>
            ...
            <p class="text-2xl font-bold text-gray-900">{format_number(@metrics.ws_total_messages)}</p>
          </div>
          <div>
      ...
      <div class={"border-l-4 p-4 #{status_color(@metrics.overall_status)}"}>
        <div class="flex">
          <div class="flex-shrink-0">
            {status_icon(@metrics.overall_status)}
          </div>
          <div class="ml-3">
  ...
  defp fetch_metrics do
    ...
    %{
      ...
      ws_total_messages: :rand.uniform(100000),
  ...
  defp status_message(:healthy), do: "All performance metrics are within acceptable ranges. System is operating normally."
  defp status_message(:warning), do: "Some performance metrics are approaching thresholds. Monitoring recommended."
  defp status_message(:critical), do: "Performance metrics have exceeded acceptable thresholds. Immediate attention required."
